(function (n) {
    var e = function () {
        ...
        t.forEach = function (n, t) {
            var u, i, r;
            for (i in this._entries) if (this._entries.hasOwnProperty(i)) for (u = this._entries[i], r = 0; r < u.length; r++) n.call(t, u[r], i, this)
        };
        t.keys = function () {
            var n = [];
    ...
    typeof t.sort != "function" && (t.sort = function () {
        ...
        }), i._entries && (i._entries = {}), t = 0; t < n.length; t++) this.append(n[t][0], n[t][1])
    });
    typeof t._fromString != "function" && Object.defineProperty(t, "_fromString", {
        ...
        value: function (n) {
            var i, u, r, t;
            if (this._entries) this._entries = {}; else for (i = [], this.forEach(function (n, t) {
                i.push(t)
            }), t = 0; t < i.length; t++) this.delete(i[t]);
            for (n = n.replace(/^\?/, ""), u = n.split("&"), t = 0; t < u.length; t++) r = u[t].split("="), this.append(f(r[0]), r.length > 1 ? f(r[1]) : "")
        }
    })
})(typeof global != "undefined" ? global : typeof window != "undefined" ? window : typeof self != "undefined" ? self : this), function (n) {
    var i = function () {
        try {
            var t = new n.URL("b", "http://a");
            return t.pathname = "c d", t.href === "http://a/c%20d" && t.searchParams
        } catch (i) {
            return !1
        }
    }, r = function () {
        var t = n.URL, i = function (t, i) {
            var u, f, r, o, c;
            if (typeof t != "string" && (t = String(t)), u = document, i && (n.location === void 0 || i !== n.location.href)) {
                u = document.implementation.createHTMLDocument("");
                f = u.createElement("base");
                f.href = i;
                u.head.appendChild(f);
                try {
                    if (f.href.indexOf(i) !== 0) throw new Error(f.href);
                } catch (l) {
                    throw new Error("URL unable to set base " + i + " due to " + l);
                }
            }
            if (r = u.createElement("a"), r.href = t, f && (u.body.appendChild(r), r.href = r.href), o = u.createElement("input"), o.type = "url", o.value = t, r.protocol === ":" || !/:/.test(r.href) || !o.checkValidity() && !i) throw new TypeError("Invalid URL");
            Object.defineProperty(this, "_anchorElement", {value: r});
            var e = new n.URLSearchParams(this.search), s = !0, h = !0, a = this;
            ["append", "delete", "set"].forEach(function (n) {
                var t = e[n];
                e[n] = function () {
                    t.apply(e, arguments);
                    s && (h = !1, a.search = e.toString(), h = !0)
                }
            });
            ...
            Object.defineProperty(this, "_updateSearchParams", {
                ...
                writable: !1,
                value: function () {
                    this.search !== c && (c = this.search, h && (s = !1, this.searchParams._fromString(this.search), s = !0))
                }
            })
        }, r = i.prototype, u = function (n) {
        ...
        Object.defineProperties(r, {
            toString: {
                ...
                get: function () {
                    var n = {"http:": 80, "https:": 443, "ftp:": 21}[this._anchorElement.protocol],
    ...
    if (i() || r(), n.location !== void 0 && !("origin" in n.location)) {
        ...
        try {
            Object.defineProperty(n.location, "origin", {get: t, enumerable: !0})
        } catch (u) {
...
}(typeof global != "undefined" ? global : typeof window != "undefined" ? window : typeof self != "undefined" ? self : this), function () {
    var n;
    n = !0;
    ...
    window.tableau._apiLoaded || (window.tableau._apiLoaded = !0, function () {
        ...
        function p(n, t) {
            ...
            for (t = t || {}, s = 0, c = h.length; s < c; s++) i = h[s], tt(i, "param") && i.name ? (r = i.name, f = i.value ? i.value : null, r === "name" ? e = f : r === "filter" ? (t.filter = t.filter || [], t.filter.push(f)) : (t[r] = f, r === "mobile" && o(f, !1) && (k = !0))) : i.childNodes && i.childNodes.length > 0 && !tt(i, "object") && (l = p(i, t), e = u(e) ? l : e);
            return e
        }
        ...
        function pt() {
            var n, t;
            return n = yt(), n ? n : (n = a(document.documentElement), t = document.compatMode === "BackCompat", t && (n.height = document.body.clientHeight - n.left, n.width = document.body.clientWidth - n.top), n.left += d(), n.top += g(), n)
        }

        function wt(n) {
            for (var r, u, i = a(n), t = n.parentElement; t && t.parentElement; t = t.parentElement) r = f(t).overflow, (r === "auto" || r === "scroll" || r === "hidden") && (i = ut(i, a(t)));
            return u = pt(), ut(i, u)
        }
        ...
        function dt() {
            var n;
            b ? (n = tableau.vizs[r[t]], n && n._iframe.readyState === "complete" && (w(t), c(t))) : (w(t), c(t))
        }
        ...
        function ii() {
            for (var n, r = document.getElementsByTagName("object"), u = [], t = 0, i = r.length; t < i; t++) n = r[t], it(n, "tableauViz") && !at(v, n) && (v.push(n), u.push(n));
            return u
        }
        ...
        function h() {
            var n, o, e, s, i, h, u = [];
            if (s = ii(), s.length !== 0) {
                for (ui(), n = 0, o = s.length; n < o; n++) e = s[n], i = {
                    filter: [],
                    ticket: "",
                    path: ""
                }, h = p(e, i), i.width = parseInt(f(e, null).width, 10), isNaN(i.width) && delete i.width, i.height = parseInt(f(e, null).height, 10), isNaN(i.height) && delete i.height, u.push({
                    name: h,
                    objectElement: e,
                    params: i
                });
                for (ri(u), n = 0, o = u.length; n < o; n++) tableau.createViz(u[n].name, u[n].objectElement, u[n].params);
                r.sort(bt);
                c(t)
            }
        }
        ...
        i.prototype.sizeIframeToObjectElement = function (t) {
            ...
            e(o) || (p(o, u), r = f(o, null).width, i = f(o, null).height, r.indexOf("%") === -1 && i.indexOf("%") === -1 && (r = parseInt(r, 10), i = parseInt(i, 10), u.embed_code_version || (r = this.adjustSlopInWidth(u, r), i = this.adjustSlopInHeight(u, i)), n && (i = this.adjustHeightForPublic(u, i)), r = r + "px", i = i + "px"), t.style.width = r, t.style.height = i)
        };
        ...
        i.prototype.determinePlaceholderSize = function (n, t) {
            var i = n.clientWidth, r = n.clientHeight;
            i = Math.round(s(i));
            r = Math.round(s(r));
            var f = Math.round(s(t.style.minHeight)), e = Math.round(s(t.style.minWidth)),
                o = Math.round(s(t.style.maxHeight)), h = Math.round(s(t.style.maxWidth)), u = ti(f, e, o, h, i, r);
        ...
        i.prototype.createLoadingFeedback = function (n, t) {
            ...
            if (a = kt(), b !== !0 || a || (t.display_spinner = "no"), this._ensurePlaceholderDiv()) {
                this.sizeToObjectElement(this._placeholderDiv);
                try {
                    if (p = this.determinePlaceholderSize(this._placeholderDiv, this._objectElement), f = p.placeholderWidth, e = p.placeholderHeight, typeof f != "number" || isNaN(f)) {
                        c = "Invalid width- " + f;
                        throw c;
                    }
                ...
                if (h = this._placeholderDiv.style, h.position = "relative", h.overflow = "hidden", h.display = "none", r = ['<div style="position:absolute;top:0;left:0;right:0;bottom:0;border:0;padding:0;margin:0">'], v = i._instanceCounter++, a || r.push('<div style="top:100px;left:0;right:0;position:absolute;z-index:991;box-shadow:none;display:flex;justify-content:center;"><style>#tableau-svg-spinner-container-%instId%{width:65px;height:65px;border-radius:10px;display:flex;justify-content:center;align-items:center}#tableau-svg-spinner-%instId%{width:50px;height:50px;-webkit-animation:tableau-svg-spinner-animation 1s linear infinite;animation:tableau-svg-spinner-animation 1s linear infinite}@-webkit-keyframes tableau-svg-spinner-animation{100%{-webkit-transform:rotate(360deg)}}@keyframes tableau-svg-spinner-animation{100%{transform:rotate(360deg)}}<\/style><div id="tableau-svg-spinner-container-%instId%"><svg id="tableau-svg-spinner-%instId%" viewBox="0 0 50 50"><style>#tail{fill:url(#tableau-fade-%instId%)}#head{fill:#616570}stop{stop-color:#616570}<\/style><linearGradient id="tableau-fade-%instId%" x2="50" y1="25" y2="25" gradientUnits="userSpaceOnUse"><stop offset="0" stop-opacity="0" /><stop offset=".15" stop-opacity=".04" /><stop offset=".3" stop-opacity=".16" /><stop offset=".45" stop-opacity=".36" /><stop offset=".61" stop-opacity=".64" /><stop offset=".76" /><\/linearGradient><path id="head" d="M0 25a25 25 0 1 0 50 0h-3.9a21.1 21.1 0 1 1-42.2 0" /><path id="tail" d="M50 25a25 25 0 0 0-50 0h3.9a21.1 21.1 0 1 1 42.2 0" /><\/svg><\/div><\/div>'.replace(/%instId%/g, v)), o(t.display_overlay, !0) && r.push("<div style='position:absolute;top:0;left:0;right:0;bottom:0;z-index:990;background-color:#EBEBEB;opacity:.24'><\/div>"), o(t.display_static_image, !0) && !u(t.static_image)) {
                    ...
                    l = {height: e, width: f, deviceScaleFactor: window.devicePixelRatio};
                    ...
                    function n(n, t) {
                        ...
                        try {
                            ...
                            for (i in t) if (t.hasOwnProperty(i)) {
                                if (r = t[i], typeof r != "number" || isNaN(r)) {
                            ...
                            return console.error("Unable to append params to the url : " + f), n
                        }
                        return u.toString()
                    }
                ...
                return r.push("<\/div>"), s = document.createElement("div"), s.innerHTML = r.join(""), this._glassPaneElement = s.firstChild, this._placeholderDiv.appendChild(this._glassPaneElement), s.innerHTML = "", s = null, this._createAndAppendIframe()
            }
        };
        ...
        i.prototype.dispose = function () {
            ...
            this._objectElement && (vt(v, this._objectElement), this._objectElement.parentNode.removeChild(this._objectElement), this._objectElement = null)
        };
        i.prototype._ensurePlaceholderDiv = function () {
            var n;
            return e(this._placeholderDiv) ? e(this._objectElement) ? !1 : (n = st(this._objectElement, "tableauPlaceholder"), n || (n = document.createElement("div"), n.className = "tableauPlaceholder", this._objectElement.parentNode.insertBefore(n, this._objectElement), n.appendChild(this._objectElement), this._objectElement.style.display = "none"), this._placeholderDiv = n, !0) : !0
        };
        ...
        window.tableau.Viz.prototype._sendVisibleRect = function () {
            var n, t, i;
            nt() && this._iframe && this._iframe.contentWindow && (n = wt(this._iframe), t = a(this._iframe), i = ["layoutInfoResp", n.left - t.left, n.top - t.top, n.width, n.height].join(","), this._iframe.contentWindow.postMessage(i, "*"))
        };
        ...
        document.addEventListener ? (document.addEventListener("DOMContentLoaded", h, !1), document.addEventListener("message", l, !1), window.addEventListener("load", h, !1), window.addEventListener("message", l, !1)) : document.attachEvent ? (document.attachEvent("onreadystatechange", h), document.attachEvent("onmessage", l), window.attachEvent("onload", h), window.attachEvent("onmessage", l)) : (window.onload = h, window.onmessage = l);
        (gt() || k) && ni();
